...
<div class="alert alert-info">当前位置<b class="tip"></b>通知栏<b class="tip"></b>意见箱列表</div>
...
<table class="tbform">
    ...
    <tr>
        ...
        <td class="detail">
            <input type="text" class="ipt" id="feedbackContent"/>
        </td>
    </tr>
...
<script src="js/biz/adviceList.js"></script>
</html>
